...
# Install utilities
RUN python3 -m pip install ipdb ipdbplugin
...
RUN echo 'Installing extensions' && \
    # scheming
    python3 -m pip install -e git+https://github.com/ckan/ckanext-scheming.git#egg=ckanext-scheming && \
    # harvest
...
FROM ubuntu:20.04
COPY . /srv/app/src/ckanext-lacountsx

RUN apk add bind-tools
RUN dig pypi.org

# Install project extension
RUN python3 -m pip install -e /srv/app/src/ckanext-lacounts && \
    python3 -m pip install -r /srv/app/src/ckanext-lacounts/requirements.txt && \
